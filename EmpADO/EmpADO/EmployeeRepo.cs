...
namespace EmpADOEmployeePayrollADO
{
    public class EmployeeRepo
    {
        public static string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=Demo194;Integrated Security=True";
